...
ALPACA_SECRET_KEY = 'yLEdB3BMHeXd4tCMu1edDPJSrkR4xfCvJtNdNXsF'
ALPACA_KEY = 'PKKFM4DVHWELIMIQER84'
ALPACA_API_BASE_URL = 'https://data.alpaca.markets/v2'
...
class Config():
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'zoinks'
